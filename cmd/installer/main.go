...
//
//	go:generate go run -tags=installer github.com/go-simpler/assert/cmd/installer path/to/pkg
//
...
func run() error {
	...
	supportFile := strings.Replace(assert.SupportFile, "github.com/go-simpler/assert", importPath, 1)
...
func writeFile(name, content string) error {
	...
	write("*/\n")
	write("\n")
	write("// Code generated by github.com/go-simpler/assert/cmd/installer. DO NOT EDIT.\n")
	write("\n")
	write(content)
